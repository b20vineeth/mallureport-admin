...
%>
<c:set var="version"  value="${initParam.version}"/>
...
<!-- Bootstrap Core CSS -->
<link href='<c:url value="/resource/css/bootstrap.min.css?version=${version}"/>'
	rel='stylesheet' type='text/css' />
<!-- Custom CSS -->
<link href='<c:url value="/resource/css/style.css?%h=2dfsssd&version=${version}"/>'
	rel='stylesheet' type='text/css' />
<!-- Graph CSS -->
<link href='<c:url value="/resource/css/font-awesome.css?version=${version}"/>'
	rel="stylesheet">
<!-- jQuery -->
<!-- lined-icons -->
<link rel="stylesheet"
	href='<c:url value="/resource/css/icon-font.min.css?version=${version}"/>' type='text/css' />
<!-- //lined-icons -->
<!-- chart -->
<script
	src="<c:url value='/resource/js/Chart.js?version=${version}'/>"></script>
<!-- //chart -->
<!--animate-->
<link href='<c:url value="/resource/css/animate.css?version=${version}"/>' rel="stylesheet"
	type="text/css" media="all">
<script src='<c:url value="/resource/js/wow.min.js?version=${version}"/>'></script>
<script>
	new WOW().init();
</script>
<!--//end-animate-->
...
<!---//webfonts--->
<!-- Meters graphs -->
<script src='<c:url value="/resource/js/UrlPath.js?s=ll&version=${version}"/>'></script>
<script src='<c:url value="/resource/js/jquery-1.10.2.min.js?version=${version}"/>'></script>
	...
	<div class="left-side sticky-left-side">
		...
		<div class="left-side-inner">
			...
			<ul class="nav nav-pills nav-stacked custom-nav">
				...
				<li><a href="#"><i class="lnr lnr-spell-check"></i>
						<span>Forms</span></a>
						
						
						<ul class="sub-menu-list">

						<li><a href="#SET01-privilege" onClick="gotoPage('SET10')"> Language</a></li>
						...
						<ul class="nofitications-dropdown">
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<ul class="dropdown-menu">
									...
									<li class="odd"><a href="#">
											<div class="user_img">
												<img
													src="<c:url value='/resource/images/1.png'/>"
													alt="">
											</div>
											<div class="notification_desc">
												<p>Lorem ipsum dolor sit amet</p>
							...
							<li class="login_box" id="loginContainer">
								<div class="search-box">
									...
									src="<c:url value='/resource/js/classie.js?version=${version}'/>"></script>
<script src='<c:url value="/resource/js/uisearch.js?version=${version}"/>'></script>
<script>
...
<li class="dropdown"><a href="#" class="dropdown-toggle"
	data-toggle="dropdown" aria-expanded="false"><i class="fa fa-bell"></i><span
...
<li class="dropdown"><a href="#" class="dropdown-toggle"
	data-toggle="dropdown" aria-expanded="false"><i class="fa fa-tasks"></i><span
	...
	<div class="modal-dialog ">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
			   ...
			   </span> &nbsp;<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<div class="modal fade" id="errorPopUp" role="dialog">
	<div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title" id='modelHeader'><span id='errorPopUpmodelHeader'></span> 
					 
				</h4>
			</div>
			<div class="modal-body" id="errorPopUpmodelBody"></div>
			<div class="modal-footer">
	...
	<div class="modal-dialog modal-confirm">
		<div class="modal-content">
			...
			<div class="modal-body text-center">
				<h4>Great!</h4>	
				<p id="modelSuccessMsg">Data has been created successfully.</p>
...
<div class="modal fade" id="progress" role="dialog">
	<div class="modal-dialog" style="width:100px;margin-top: 25%;">

		<!-- Modal content-->
		<div class="modal-content">
			 
			<div class="modal-body" id="modelBody" align='center'><div class="loader"></div>
</div>
...
<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="mi-modal">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header">  <h4 class="modal-title">  <span id="confirmTitle"></span></h4>
      </div>
      <div class="modal-footer">
      <input type="hidden" id="modelResponseId" name="modelResponseId" value=""/>
...
<script src='<c:url value="/resource/js/jquery.nicescroll.js?version=${version}"/>'></script>
<script src='/resource/js/scripts.js?k=<%=n %>'></script>
<!-- Bootstrap Core JavaScript -->
<script src='<c:url value="/resource/js/bootstrap.min.js?version=${version}"/>'></script>
</body>
</html>
