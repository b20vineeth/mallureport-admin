...
function parent_disable() {
 ...
 <body onFocus="parent_disable();" onclick="parent_disable();">
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div style="min-height: 100px;">Mallureport.com</div>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-12">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav">
							<li class="nav-item active"><a class="nav-link"
								href="javascript:void(0)">Link <span class="sr-only">(current)</span></a>
							</li>
							...
							<li class="nav-item dropdown"><a
								...
								<div class="dropdown-menu"
									...
									<a class="dropdown-item" href="javascript:void(0)">Action</a> <a
										class="dropdown-item" href="javascript:void(0)">Another
										action</a> <a class="dropdown-item" href="javascript:void(0)">Something
										else here</a>
