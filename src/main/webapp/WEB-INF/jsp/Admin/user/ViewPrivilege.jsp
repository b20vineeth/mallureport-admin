...
%>
<script src='/resource/js/admin/Privilege.js?version=<%=n%>${version}'></script>
...
<div class="row">
	...
	<div class="col-sm-3" align='right'>
		...
		<a href='javascript:openPopup("C");'><i class="fa fa-plus"
			title="Create New Privilege" data-toggle="tooltip"
			...
			class="fas fa-user-secret" title="Privilege Group"
 ...
 <div class="row"> 
       <div class="col-sm-1" align="right"> Search :&nbsp;</div>
         <div class="col-sm-2">
 		 ...
 		 <input id="searchPrivilegeName" name="searchPrivilegeName" type="text"   placeholder="Privilege Code" class="form-control input-md" required="privilege Code is required">
        ...
        <div class="col-sm-2">
 		 ...
 		 <input id="searchPrivilegeCode" name="searchPrivilegeCode" type="text"   placeholder="Privilege Name" class="form-control input-md" required="privilege Code is required">
...
<table id="dataTable" class="table  table-fixed  table-bordered">
	<thead id='tableHeader'>
		<tr>
			...
			<th class="col-xs-2 table-row-height">Privilege Name</th>
			<th class="col-xs-3 table-row-height">Privilege Code</th>
