...
<div class="row">
	...
	<div class="col-sm-9 clearfix">
		<h5>View Settings</h5>
		<hr />
	<p align="right">	<a href="admin.settings.create?type=${type}"><i
				...
				<tbody>
					...
					<c:forEach items="${response.objectList}" var="objectList">
						...
						<tr>
							...
							<td><a
								href="javascript:editSlideShow(${objectList.settingsId})">
									<i class="fa fa-edit pointer"
									style="font-size: 20px; color: Green"> </i>
							</a><a href="javascript:deleteSlideShow(${objectList.settingsId})">
...
<script>
	function editSlideShow(id) {
		window.location.href = "admin.settings.edit?settingsId=" + id;
 ...
 debugger;
	 	$.ajax({
			...
			type : 'POST',
			data : "data=" + '{ "settings": "' + id + '" ,"status": "N"} ',
			processData : false,
			success : function(data) {
				if (data == "T") {
					window.location.href = "/admin.settings.view?type="+$('#type').val();
				} else {
