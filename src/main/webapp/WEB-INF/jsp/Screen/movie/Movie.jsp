                     ...
                     <div id="carouselExampleSlidesOnly" class="carousel slide"
                        ...
                        <div class="carousel-inner">
                           <div class="carousel-item active">
                              <img class="d-block w-100" src="${url}img/pic1.jpg"
                                 alt="First slide">
                           </div>
                           <div class="carousel-item">
                              <img class="d-block w-100" src="${url}img/pic2.jpg"
                                 alt="Second slide">
                           </div>
                           <div class="carousel-item">
                              <img class="d-block w-100" src="${url}img/pic3.jpg"
                                 alt="Third slide">
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-lg-4 top-post-right">
                     <div class="single-top-post">
                        <div class="feature-image-thumb relative">
                           ...
                           <img class="img-fluid" src="${url}img/top-post2.jpg" alt="">
                        </div>
                     ...
                     <div class="single-top-post mt-10">
                        <div class="feature-image-thumb relative">
                           <div class="overlay overlay-bg"></div>
                           <img class="img-fluid" src="${url}img/top-post3.jpg" alt="">
                        </div>
                        <div class="top-post-details">
                           <ul class="tags">
                              <li><a href="#">Food Habit</a></li>
                  ...
                  <div class="col-lg-8 post-list">
                     ...
                     <div class="popular-post-wrap">
                        ...
                        <div>
                           <ul class="nav nav-tabs">
                              <li class="active"><a href="#">Hollywood</a>&nbsp;</li>
                        ...
                        <div class="row mt-20 medium-gutters">
                           <div class="col-lg-6 single-popular-post">
                              <div class="feature-img-wrap relative">
                                 <div class="feature-img relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="${url}img/f2.jpg" alt="">
                                 </div>
                                 <ul class="tags">
                           ...
                           <div class="col-lg-6 single-popular-post">
                              <div class="feature-img-wrap relative">
                                 <div class="feature-img relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="${url}img/f3.jpg" alt="">
                                 </div>
                                 <ul class="tags">
                                    <li><a href="#">Travel</a></li>
                                 </ul>
                     ...
                     <div class="popular-post-wrap">
                        ...
                        <div class="feature-post relative">
                           <div class="feature-img relative">
                              <div class="overlay overlay-bg"></div>
                              <img class="img-fluid" src="${url}img/f1.jpg" alt="">
                           </div>
                           <div class="details">
                              <ul class="tags">
                                 <li><a href="#">Food Habit</a></li>
                        ...
                        <div class="relavent-story-list-wrap">
                           <div class="single-relavent-post row align-items-center">
                              <div class="col-lg-5 post-left">
                                 <div class="feature-img relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="${url}img/r1.jpg" alt="">
                                 </div>
                                 <ul class="tags">
                              ...
                              <div class="col-lg-7 post-right">
                                 ...
                                 <p class="excert">Lorem ipsum dolor sit amet, consectetur
                           ...
                           <div class="single-relavent-post row align-items-center">
                              <div class="col-lg-5 post-left">
                                 <div class="feature-img relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="${url}img/r2.jpg" alt="">
                                 </div>
                                 <ul class="tags">
                           ...
                           <div class="single-relavent-post row align-items-center">
                              <div class="col-lg-5 post-left">
                                 <div class="feature-img relative">
                                    <div class="overlay overlay-bg"></div>
                                    <img class="img-fluid" src="${url}img/r3.jpg" alt="">
                                 </div>
                                 <ul class="tags">
                                    <li><a href="#">Travel</a></li>
                                 </ul>
